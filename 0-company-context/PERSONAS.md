# RemoFlow User Personas

**Deep dive into who uses RemoFlow and why**

---

## Overview

RemoFlow serves three primary user personas across our customer base. Understanding these personas is critical for product decisions - every feature should serve at least one persona's core needs.

---

## Persona 1: Jessica (Enterprise Admin)
...
**RemoFlow Plan:** Enterprise

### Background

Jessica leads IT operations for a fast-growing SaaS company. Her team supports 800 employees across 15 tools. She reports to the CTO and owns IT budget ($2M annually).
...
### RemoFlow Features They Care About
...
**RemoFlow Plan:** Pro (company-wide)

### Background

Joseph is a senior engineer focused on backend systems. He codes 6-8 hours per day, attends 2-3 meetings per week, works across 4 timezones with distributed team.
...
## Persona 3: Thomas (Team Lead)

### Quick Facts

**Name:** Thomas Banderas
**Age:** 35
...
Thomas manages a distributed engineering team. Former senior engineer, promoted to manager 2 years ago. Still codes occasionally (~20% time) but primarily focuses on team productivity, hiring, and delivery.
...
- GitHub (code), RemoFlow (tasks), Slack (communication), Figma (designs), Notion (docs)
...
| Attribute | Jessica (Enterprise Admin) | Joseph (IC Engineer) | Thomas (Team Lead) |
|-----------|-------------------------|-------------------|------------------|
...
| **RemoFlow priorities** | SSO, audit logs, permissions | Speed, keyboard shortcuts, GitHub | Dashboard, workload view, reports |
...
- Would actively advocate for RemoFlow because of this
...
- High value for Joseph persona (retention + advocacy)
- Low cost to build
...
1. **Mobile app** → All personas benefit
   - Jessica: Team uses mobile for on-the-go
   - Joseph: Review tasks during commute
   - Thomas: Check team status while traveling

2. **SSO & enterprise features** → Jessica's blocker
   - Critical for enterprise segment
   - High revenue impact
   - Competitive requirement

3. **Activation improvements** → Joseph's first experience
   - Faster time to value
   - Better onboarding
   - Reduces churn

4. **Dark mode** → Joseph's delight factor
   - Highly requested
   - Differentiation
