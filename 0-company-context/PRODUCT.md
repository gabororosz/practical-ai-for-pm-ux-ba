# RemoFlow Product Overview

**Your complete guide to the RemoFlow product**

---

## What is RemoFlow?

RemoFlow is a project management SaaS for remote teams. Think **"Asana meets Linear"** - beautiful like Linear, functional like Asana, but built specifically for how remote teams work.

### Core Value Proposition

**For remote teams who struggle with scattered work and unclear priorities,** RemoFlow is a project management tool **that provides context-rich task management and async collaboration.** Unlike Asana (complex, expensive) or Trello (too simple), RemoFlow **balances simplicity with power, at 50% lower cost.**
...
**Our differentiation:**
- **Two-way sync:** Changes in RemoFlow update connected tools
...
**Goal (Q1 2026):** 1,200 weekly active teams
...
|------|------------|----------|------------|
| **RemoFlow** | Free | $12/user/mo | Custom |
...
- **RemoFlow:** Roadmap, feature tracking (we dogfood!)

---

**Throughout this course, you'll write PRDs, generate user stories, analyze research, and plan features for RemoFlow. You're not learning in a vacuum - you're working on a real (fictional) product! 🎯**
